...
echo "=== 导出 Developer ID Application 证书 ==="
echo ""
echo "请按照以下步骤操作："
echo ""
echo "1. 打开「钥匙串访问」应用"
...
echo "4. 找到「Developer ID Application: Guangzhou Youyidian Intelligence Technology Co.,Ltd」"
echo "5. 右键点击 -> 导出"
echo "6. 保存为: ~/Desktop/developer-id.p12"
echo "7. 设置一个密码（记住这个密码）"
echo ""
read -p "完成后按回车继续..."

if [ ! -f ~/Desktop/developer-id.p12 ]; then
    echo "错误: 未找到 ~/Desktop/developer-id.p12"
    exit 1
fi
...
# 转换为 base64
CERT_BASE64=$(base64 -i ~/Desktop/developer-id.p12 | tr -d '\n')
...
echo "Developer ID Application: Guangzhou Youyidian Intelligence Technology Co.,Ltd (YGTQGCDN2W)"
echo ""
echo "APPLE_TEAM_ID:"
echo "YGTQGCDN2W"
echo ""
